 ...
 */
public class JDlgEditDepartamentos extends javax.swing.JDialog {
    ...
    private final Departamento departamentoEditado;
    ...
    private void doClose(int retStatus) {
        if (retStatus == RET_OK) {
            departamentoEditado.setNombre(jTextNombre.getText());
        }
